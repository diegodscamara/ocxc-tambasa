...
export const TmbHeaderLogo = () => import('../index');

describe('TmbHeaderLogo renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbHeaderLogo};
  beforeAll(async () => {
    /**
  ...
  it('TmbHeaderLogo works as expected', async done => {
    /**
