 ...
 */
  ...
  * @param props
  */
 const TmbCheckoutSingleShippingDetails = props => {
   // resources
   ...
   return (
     <Styled css={css} id="TmbCheckoutSingleShippingDetails">
       <div className="TmbCheckoutSingleShippingDetails">
 ...
 TmbCheckoutSingleShippingDetails.propTypes = {
   /**
 ...
 TmbCheckoutSingleShippingDetails.defaultProps = {
   contactInfos: {},
   roles: [],
   defaultShippingCountry: ''
 };
 
 export default connect(getComponentData)(TmbCheckoutSingleShippingDetails);
