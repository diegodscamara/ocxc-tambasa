...
export const TmbCartOrderSummaryContainer = () => import('../index');

describe('TmbCartOrderSummaryContainer renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCartOrderSummaryContainer};
  beforeAll(async () => {
    /**
  ...
  it('TmbCartOrderSummaryContainer works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbCartOrderSummaryContainer',
            regions: []
          }
        }
      }
