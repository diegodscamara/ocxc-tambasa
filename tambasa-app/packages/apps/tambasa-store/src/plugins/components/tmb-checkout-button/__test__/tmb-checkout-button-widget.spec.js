...
export const TmbCheckoutButton = () => import('../index');

describe('TmbCheckoutButton renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCheckoutButton};
  beforeAll(async () => {
    /**
  ...
  it('TmbCheckoutButton works as expected', async done => {
    /**
