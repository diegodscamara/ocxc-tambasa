        ...
        <div className={'PurchaseList__SearchResults'}>
          {records &&
            records.map((record, index) => (
              ...
              ? <div
                  key={
                    (record.records[0].attributes['product.repositoryId'] &&
                    record.records[0].attributes['product.repositoryId'][0]) 
                    || index
                  }
                  className={`${index > 0
                  ...
                  >
                    ...
                    <div className="PurchaseList__SearchResults_RecordColumn PurchaseList__SearchResults_Price">
                      <div className="PurchaseList__SearchResults_PriceItem">
                        {record.records[0].attributes['sku.activePrice'] && record.records[0].attributes['sku.activePrice'][0] && (
                          <b>
                            { 
