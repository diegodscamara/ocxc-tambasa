  ...
  return (
    <Styled id="CardDetails" css={css}>
      <div className="custom-container">
          ...
          <div className="CardDetails">
            <div className="CardDetails__Row">
              ...
              <input
                type="text"
                id={`nameOnCard-${id}`}
                placeholder={remProps.labelNameOnCard}
                name="nameOnCard"
            ...
            <div className="CardDetails__Row CardDetails__CardNumberAndTypeContainer">
              <div className="CardDetails__CardNumberContainer">
                ...
                <input
                  ...
                  id={`cardNumber-${id}`}
                  name="cardNumber"
                  placeholder={remProps.labelCardNumber}
              ...
              <div className="CardDetails__Cvv">
                ...
                <div className="CardDetails__CvvInputAndCCVIconContainer">
                  <input
                    ...
                    type="password"
                    placeholder={remProps.labelCardCVV}
                    id={`cardCVV-${id}`}
                    name="cardCVV"
                    required
                    disabled={!cardTypes}
        ...
        <div className="custom-col-md-6 custom-col-sm-12 pl-2">
          <div className="card-container-add ProfileSavedCards__ListItem">

            <div className={`ProfileSavedCards__Item ProfileSavedCards__Item___Front`}>
              <div id={`cardDetails-${id}`} className="ProfileSavedCards__CardDetailsContainer">
                <div className="ProfileSavedCards__CardTypeContainer">
                  ...
                  {cardDetails.cardType && cardDetails.cardType.img && cardDetails.cardType.img.url && (
                    <img className="ProfileSavedCards__CardTypeImg" src={cardDetails.cardType.img.url} alt={"Card Flag"} />
                  )}
                </div>
                <div className="ProfileSavedCards__CardDetailsWrapper">
                  <div className="ProfileSavedCards__CardNumber">
                    ...
                    {
                      (() => {
                        const formattedNumber = formatCardNumber(cardDetails.cardNumber, " ")
                        return formattedNumber.split(/\s/g).map((group, index) => <span key={index}>{group}</span>)
                      })()
                    }
                  </div>
                  <div id={`expiryDate-${id}`} className="ProfileSavedCard__ExpiryDate">
                    <div className="ProfileSavedCard__ExpiryDate___ValidThruContainer">
                      ...
                      <p className="ProfileSavedCard__ExpiryDate___Date"> {cardDetails.expiryMonth && cardDetails.expiryYear && (
                        <>
                  ...
                  <span className="ProfileSavedCard__NameOnCard">{cardDetails.nameOnCard}</span>
