...
export const TmbSearchbox = () => import('../index');

describe('TmbSearchbox renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbSearchbox};
  beforeAll(async () => {
    /**
  ...
  it('TmbSearchbox works as expected', async done => {
    /**
