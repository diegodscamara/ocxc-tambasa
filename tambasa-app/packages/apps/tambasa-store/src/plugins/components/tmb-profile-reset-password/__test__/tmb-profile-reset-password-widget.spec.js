...
export const TmbProfileResetPassword = () => import('../index');

describe('TmbProfileResetPassword renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbProfileResetPassword};
  beforeAll(async () => {
    /**
  ...
  it('TmbProfileResetPassword works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbProfileResetPassword',
            regions: []
          }
        }
      }
