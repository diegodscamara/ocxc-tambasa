...
export const tmb404Error = () => import('../index');

describe('tmb404Error renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {tmb404Error};
  beforeAll(async () => {
    /**
  ...
  it('tmb404Error works as expected', async done => {
    /**
