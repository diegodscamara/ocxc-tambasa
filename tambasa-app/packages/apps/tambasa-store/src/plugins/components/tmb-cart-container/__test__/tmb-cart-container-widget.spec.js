...
export const TmbCartContainer = () => import('../index');

describe('TmbCartContainer renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCartContainer};
  beforeAll(async () => {
    /**
  ...
  it('TmbCartContainer works as expected', async done => {
    /**
