...
export const TmbCheckoutOrderConfirmationButtonContainer = () => import('../index');

describe('TmbCheckoutOrderConfirmationButtonContainer renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCheckoutOrderConfirmationButtonContainer};
  beforeAll(async () => {
    /**
  ...
  it('TmbCheckoutOrderConfirmationButtonContainer works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbCheckoutOrderConfirmationButtonContainer',
            regions: []
          }
        }
      }
