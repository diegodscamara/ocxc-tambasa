...
export const TmbTradePolicy = () => import('../index');

describe('TmbTradePolicy renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbTradePolicy};
  beforeAll(async () => {
    /**
  ...
  it('TmbTradePolicy works as expected', async done => {
    /**
