...
export const TmbContinueShoppingButton = () => import('../index');

describe('TmbContinueShoppingButton renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbContinueShoppingButton};
  beforeAll(async () => {
    /**
  ...
  it('TmbContinueShoppingButton works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbContinueShoppingButton',
            regions: []
          }
        }
      }
