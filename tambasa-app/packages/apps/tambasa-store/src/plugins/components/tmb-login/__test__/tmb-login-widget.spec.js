...
export const TmbLogin = () => import('../index');

describe('TmbLogin renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbLogin};
  beforeAll(async () => {
    /**
  ...
  it('TmbLogin works as expected', async done => {
    /**
