...
* @param props
*/
const TmbCheckoutCreditCard = props => {
  const {
  ...
  */
  ...
  // On render we'd like to call this function
  useEffect(() => {
  ...
  return (
    <React.Fragment>
      {useMemo(
        () => (
          <Styled id="TmbCheckoutCreditCard" css={css}>
            {isDisplayCreditCard &&
              validatePaymentsEnabled(
                ...
                <React.Fragment>
                  <div className="TmbCheckoutCreditCard CheckoutPaymentsGroup">
                    {!savedCardExists && (
                      <div className="TmbCheckoutCreditCard__RadioButtonContainer">
                        <RadioButton
                    ...
                    <form ref={formElementRef} noValidate>
                      <React.Fragment>
                        ...
                        <div
                          className={`TmbCheckoutCreditCard__AddCardDetailsContainer ${
                            isCardDetailsEntryHidden() ? ' TmbCheckoutCreditCard__AddCardDetailsContainer--hidden' : ''
                          }`}
                        >
                          <AddCardDetails
                            {...props}
...
TmbCheckoutCreditCard.propTypes = {
  /**
...
TmbCheckoutCreditCard.defaultProps = {
...
export default connect(getCheckoutCreditCardData)(TmbCheckoutCreditCard);
