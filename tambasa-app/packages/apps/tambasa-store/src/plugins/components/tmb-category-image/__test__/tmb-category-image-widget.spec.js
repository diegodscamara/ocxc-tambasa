...
export const TmbCategoryImage = () => import('../index');

describe('TmbCategoryImage renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCategoryImage};
  beforeAll(async () => {
    /**
  ...
  it('TmbCategoryImage works as expected', async done => {
    /**
