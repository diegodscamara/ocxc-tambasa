...
const ProductImageSlider = props => {
  ...
  return (
    <Styled id="TmbProductImageViewer__Slider" css={css}>
      <div className="TmbProductImageViewer__Slider" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
        {!showExpand && (
          <p className="TmbProductImageViewer__SliderNumbers">
            {currentIndex + 1} of {images.length}
          </p>
        )}
        <div className="TmbProductImageViewer__SliderImage" ref={imageContainer}>
          <div
            className="TmbProductImageViewer__SliderWrapper"
        ...
        {displayImageZoom && !mobile && showExpand && (
          <div className="TmbProductImageViewer__HelpText">{imageHover ? lableOpenExpandedView : labelRollOverImage}</div>
        )}
