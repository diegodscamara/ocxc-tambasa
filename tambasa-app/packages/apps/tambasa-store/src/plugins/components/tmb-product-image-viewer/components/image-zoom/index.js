...
const ImageZoom = props => {
  ...
  const handleZoomIn = useCallback(() => {
    imageContainer.current.classList.add('TmbProductImageViewer__ZoomIn');
  ...
  const handleZoomOut = useCallback(() => {
    imageContainer.current.classList.remove('TmbProductImageViewer__ZoomIn');
  ...
  return (
    <Styled id="TmbProductImageViewer__ImageZoom" css={css}>
      {showLens && (
        <div className="TmbProductImageViewer__ImageZoom">
          <div className="TmbProductImageViewer__ZoomLens" ref={lensElement}></div>
          <div className="TmbProductImageViewer__ZoomImage" ref={zoomImageElement}></div>
        </div>
      )}
    </Styled>
  );
