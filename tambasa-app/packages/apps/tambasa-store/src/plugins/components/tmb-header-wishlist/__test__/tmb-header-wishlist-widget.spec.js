...
export const TmbHeaderWishlist = () => import('../index');

describe('TmbHeaderWishlist renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbHeaderWishlist};
  beforeAll(async () => {
    /**
  ...
  it('TmbHeaderWishlist works as expected', async done => {
    /**
