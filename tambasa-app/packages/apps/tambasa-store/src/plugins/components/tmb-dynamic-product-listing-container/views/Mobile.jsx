...
*/
const TmbDynamicProductListingContainerMobile = props => {
  ...
  return (
    mobile 
    ? <Styled id="TmbDynamicProductListingContainer--Mobile" css={css}>
...
TmbDynamicProductListingContainerMobile.propTypes = {
  /**
...
TmbDynamicProductListingContainerMobile.defaultProps = {
  redirect: {},
  results: null,
  regions: [],
  contextId: null
...
export default connect(getComponentData)(TmbDynamicProductListingContainerMobile);
