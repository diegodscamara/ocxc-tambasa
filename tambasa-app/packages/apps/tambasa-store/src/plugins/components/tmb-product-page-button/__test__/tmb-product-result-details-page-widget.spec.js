...
export const TmbProductResultDetailsPage = () => import('../index');

describe('TmbProductResultDetailsPage renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbProductResultDetailsPage};
  beforeAll(async () => {
    /**
  ...
  it('TmbProductResultDetailsPage works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbProductResultDetailsPage',
            regions: []
          }
        }
      }
