...
export const TmbMiniCart = () => import('../index');

describe('TmbMiniCart renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbMiniCart};
  beforeAll(async () => {
    /**
  ...
  it('TmbMiniCart works as expected', async done => {
    /**
