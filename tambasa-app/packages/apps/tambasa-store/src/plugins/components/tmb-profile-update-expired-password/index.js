...
const TmbProfileUpdateExpiredPassword = props => {
    ...
    return (
      <div className="ProfileUpdateExpiredPassword__StatusMessage">
        ...
        <div className="button-container-reset-password">
          <button type="button" className="submit-button-reset-password" onClick={navigateToHomePage}>
            {buttonContinue}
          </button>
        </div>
      </div>
  ...
  const getPasswordUpdateTokenFailure = () => {
    return (
      <div className="ProfileUpdateExpiredPassword__StatusMessage">
        ...
        <div className="button-container-reset-password">
          <button type="button" className="submit-button-reset-password" onClick={navigateToHomePage} aria-label={buttonContinue}>
            {buttonContinue}
          </button>
        </div>
      </div>
        ...
        >
          ...
          <div className="ProfileUpdateExpiredPassword__Email">
            <div className="ProfileUpdateExpiredPassword__EmailField">
              ...
              <input type="email" name="login" id={`login-${id}`} placeholder={labelEmailAddress} required />
          ...
          <div>
            <div className="ProfileUpdateExpiredPassword__PasswordField">
              ...
              <input type="password" name="password" id={`password-${id}`} placeholder={labelNewPassword} required />
              <span className="validationMessage"></span>
            </div>
          </div>
          ...
          <div>
            <div className="ProfileUpdateExpiredPassword__PasswordField">
              <PasswordIcon className="ProfileUpdateExpiredPassword__PasswordIcon" />
              <input type="password" name="confirmPassword" id={`confirmPassword-${id}`} placeholder={labelConfirmNewPassword} required />
              <span className="validationMessage"></span>
            </div>
          </div>
          <div className="button-container-reset-password">
            <button type="submit" className="submit-button-reset-password" disabled={inProgress}>
              {buttonSubmit}
            </button>
          </div>
        </Form>
  ...
  return (
    <Styled id="TmbProfileUpdateExpiredPassword" css={css}>
...
export default connect(getPageData)(TmbProfileUpdateExpiredPassword);
