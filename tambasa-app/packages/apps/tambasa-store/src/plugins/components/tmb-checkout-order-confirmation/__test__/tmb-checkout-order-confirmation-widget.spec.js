...
export const TmbCheckoutOrderConfirmation = () => import('../index');

describe('TmbCheckoutOrderConfirmation renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbCheckoutOrderConfirmation};
  beforeAll(async () => {
    /**
  ...
  it('TmbCheckoutOrderConfirmation works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbCheckoutOrderConfirmation',
            regions: []
          }
        }
      }
