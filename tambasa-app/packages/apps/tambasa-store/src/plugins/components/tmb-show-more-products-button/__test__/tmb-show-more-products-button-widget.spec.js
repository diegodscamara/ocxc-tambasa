...
export const TmbShowMoreProductsButton = () => import('../index');

describe('TmbShowMoreProductsButton renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbShowMoreProductsButton};
  beforeAll(async () => {
    /**
  ...
  it('TmbShowMoreProductsButton works as expected', async done => {
    /**
    ...
    const state = {
      pageRepository: {
        widgets: {
          dsWidgetInstance: {
            id: 'dsWidgetInstance',
            componentId: 'TmbShowMoreProductsButton',
            regions: []
          }
        }
      }
