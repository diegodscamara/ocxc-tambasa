...
export const TmbImage = () => import('../index');

describe('TmbImage renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbImage};
  beforeAll(async () => {
    /**
  ...
  it('TmbImage works as expected', async done => {
    /**
