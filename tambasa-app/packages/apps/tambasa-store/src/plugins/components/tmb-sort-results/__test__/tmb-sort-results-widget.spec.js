...
export const TmbSortResults = () => import('../index');

describe('TmbSortResults renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TmbSortResults};
  beforeAll(async () => {
    /**
  ...
  it('TmbSortResults works as expected', async done => {
    /**
