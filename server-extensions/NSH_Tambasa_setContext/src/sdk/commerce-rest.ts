 ...
 */
 function CommerceSDK (this: any, configuration: Configuration) {
  'use strict';
  if (!configuration) {
 ...
 */
CommerceSDK.stringifyPrimitive = function (primitive: any) {
  'use strict';
  if (primitive) {
 ...
 */
CommerceSDK.stringifyQueryString = function (object: any) {
  'use strict';
  var separatorSymbol = '&';
  var equalSymbol = '=';
 ...
 */
CommerceSDK.prototype.setAccessToken = function (token: any) {
  'use strict';
...
CommerceSDK.prototype.login = function () {
  ...
  var loginPromise = new Promise (
    ...
    function (resolve, reject) {
      ...
      var loginOptions = function (requestOptions: any) {
      ...
      self.request ({url : '/ccadmin/v1/login',
        ...
        data : data ,
        callback : function (err: any, response: any) {
...
CommerceSDK.prototype.logout = function () {
  ...
  var logoutPromise = new Promise (
    function (resolve, reject) {
      ...
      self.post ({url : '/ccadmin/v1/logout', data : {},  callback : function (err: any, response: any) {
...
CommerceSDK.prototype.isValidToken = function () {
  ...
  var validPromise = new Promise (
    function (resolve, reject) {
      ...
      self.request ({url : '/ccadmin/v1/verify', method: 'post', data : requestData, callback : function (err: any, response: any) {
 ...
 * </UL>
 */
CommerceSDK.prototype.request = function (args: any) {
  'use strict';
  var self = this;
  ...
  var currentRequest = requestModule.request (requestOptions, function (response: any) {
 ...
 */
CommerceSDK.prototype.get = function (urlOptions: any) {
  ...
  if (data) {
    var appendChar = urlOptions.url.indexOf(false) ? '?' : '&';
  ...
  initPromise.then (function (success: any) {
    if (success === true) {
 ...
 * @see CommerceSDK#init option for initializing the CommerceSDK instance.
 */
CommerceSDK.prototype.post = function (urlOptions: any, sdk?: any) {
  'use strict';
  var self = this;
  if (!urlOptions) {
    throw new Error ('The url options cannot be null');
 ...
 * @see CommerceSDK#init option for initializing the CommerceSDK instance.
 */
CommerceSDK.prototype.put = function (urlOptions: any, sdk?: any) {
  'use strict';
  var self = this;
  if (!urlOptions) {
    throw new Error ('The url options cannot be null');
 ...
 * @see CommerceSDK#init option for initializing the CommerceSDK instance.
 */
CommerceSDK.prototype.delete = function (urlOptions: any) {
  'use strict';
  var self = this;
  if (!urlOptions) {
    throw new Error ('The url options cannot be null');
 ...
 */
CommerceSDK.prototype.init = function (endpoint: any ) {
  'use strict';
  var self = this;
  ...
  var initPromise = new Promise (
    function (resolve, reject) {
      ...
      if (!self.accessToken) {
        ...
        loginPromise.then (function (lp: any) { // jshint ignore:line
          resolve (true);
        }).catch(function (err: any) {
        ...
        tokenPromise.then (function (success: any) {
          if (success === true) {
 ...
 */
CommerceSDK.isErrorResponse = function (response: any) {
  'use strict';
  if (response) {
 ...
 * console.
 */
CommerceSDK.printDebugMessage = function (message: any, sdk?: any) {
  'use strict';
  sdkDebugLog (message);
};
 ...
 * console.
 */
CommerceSDK.printError = function (message: any, error: any, sdk?: any) {
  'use strict';
  if (message) {
 ...
 */
CommerceSDK.printProperties = function (obj: any, sdk?: any) {
  'use strict';
  sdkDebugLog('%j', obj);
};
...
/* export class OCC {
  private constructor(){}
  static get(hostname: string, apiKey: string){
    const config: Configuration = {hostname, apiKey,port:3000,host:'', logger: ''}
    return CommerceSDK(config);
  }
}
 */
